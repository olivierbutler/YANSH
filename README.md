...
#### History
- 3.19 Allow direct SimBrief username entry
- 3.17 Harden FMC flight number and cruise altitude  
- 3.18 Fix crash in FMC flight-number handling when OFP fields are non-string
- 3.16 Fix issue when OFP not correctly generated by simbrief, Add UMFC simbrief dowmload for all  
- 3.15 Add UMFC simbrief dowmload for B748 
- 3.14 Display keyboard shortcut in the menu 
